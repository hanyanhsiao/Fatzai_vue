    ...
    <main class="cart">
          ...
          <ul class="car_item">
            ...
            <li class="num">
              <ul class="count">
                ...
                <li><input readonly disabled type="text" class="input-num" id="input-num" value="${item.num}" />
                </li>
      ...
      <div class="more">
        ...
        <ul class="more_items">
          ...
          <li>
            <router-link to="./itemView"><img src="../assets/image/items/mousse8.jpg" />
            </router-link>
...
.cart {
  ...
  .car {
    ...
    .car_title {
      ...
      @include pad {
        padding: 10px 5px;
        grid-template-columns: 1fr 1.5fr 1.5fr 1.6fr .8fr;
      }
