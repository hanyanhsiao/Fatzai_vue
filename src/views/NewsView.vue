    ...
    <main>
      ...
      <div class="new_block" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="each_news">
          ...
          <div class="btn_block">
            <button>
              <!-- <a href="./shop_list_all.html?product=cupcake_tab">立即購買</a> -->
              <router-link to="/ItemList.vue?product=cupcake_tab">立即購買</router-link>
            </button>
          </div>
        </div>
        ...
        <div class="each_news">
          ...
          <div class="news_text">
            ...
            <p>
              草莓季節到了！如果你是甜點愛好者，那麼你絕對不能錯過，草莓因其美味和鮮艷的顏色而倍受喜愛，無論你喜歡哪種甜點，草莓總是可以給你帶來美好的口感和愉悅的體驗，這次除了歷年經典草莓塔外，還多了草莓杯子蛋糕、愛心形狀的草莓馬卡龍，以及送禮看起來最有面子的6吋草莓夏洛特，不要猶豫，現在就去品嚐一個草莓甜點吧！
            </p>
          </div>
          <div class="btn_block">
            <button>
              <!-- <a href="./shop_list_all.html?product=season_tab">立即購買</a> -->
              <router-link to="/ItemList.vue?product=season_tab">立即購買</router-link>
